...
description: When the user asks about long-term memory, choose read_memory for calendar date/range reads and search_vector_memory for semantic retrieval by meaning.
tools: ["read_memory", "search_vector_memory"]
---
