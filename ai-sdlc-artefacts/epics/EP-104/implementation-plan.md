...
**Next:** —  
**Related:** [ep-requirements.md](ep-requirements.md), [ep-system-design.md](ep-system-design.md), [strategy.md](../../strategy.md), [08-user-stories.md](08-user-stories.md)
...
- [x] 1. Set up Go module and package structure
  ...
  - _Requirements:_ [REQ-002](ep-requirements.md#interface-and-deployment), [REQ-012](ep-requirements.md#extensibility-and-architecture)
...
- [x] 1.1 Implement config load and validation
  ...
  - _Requirements:_ [REQ-003](ep-requirements.md#nodes-and-ssh), [REQ-004](ep-requirements.md#nodes-and-ssh), [REQ-024](ep-requirements.md#nodes-and-ssh), [REQ-030](ep-requirements.md#configuration-paths-and-environment)
  ...
  - _Acceptance Criteria:_ [AC-005](stories/US-03/st-acceptance-criteria.md#ac-005), [AC-033](stories/US-19/st-acceptance-criteria.md#ac-033) (config file and referenced files), [AC-042](stories/US-20/st-acceptance-criteria.md#ac-042) (path resolution from env)
...
- [x] 1.2 Write unit tests for config validation
  ...
  - _Acceptance Criteria:_ [AC-005](stories/US-03/st-acceptance-criteria.md#ac-005)
...
- [x] 2.1 Implement per-node allowlist model
  ...
  - _Requirements:_ [REQ-005](ep-requirements.md#nodes-and-ssh)
  - _User Stories:_ [US-04](08-user-stories.md#us-04--per-node-allowlist)
  - _Acceptance Criteria:_ [AC-007](stories/US-04/st-acceptance-criteria.md#ac-007), [AC-008](stories/US-04/st-acceptance-criteria.md#ac-008)
...
- [x] 2.2 Enforce dedicated SSH user per node
  ...
  - _Requirements:_ [REQ-013](ep-requirements.md#nodes-and-ssh)
  - _User Stories:_ [US-05](08-user-stories.md#us-05--dedicated-pa-user-per-node)
  - _Acceptance Criteria:_ [AC-009](stories/US-05/st-acceptance-criteria.md#ac-009), [AC-010](stories/US-05/st-acceptance-criteria.md#ac-010)
...
- [x] 2.3 Write unit tests for allowlist and dedicated user
  ...
  - _Requirements:_ [REQ-005](ep-requirements.md#nodes-and-ssh), [REQ-013](ep-requirements.md#nodes-and-ssh)
  ...
  - _Acceptance Criteria:_ [AC-007](stories/US-04/st-acceptance-criteria.md#ac-007), [AC-008](stories/US-04/st-acceptance-criteria.md#ac-008), [AC-009](stories/US-05/st-acceptance-criteria.md#ac-009)
...
- [x] 3.1 Implement LLM provider interface and one implementation
  ...
  - _Requirements:_ [REQ-008](ep-requirements.md#llm-and-logging), [REQ-024](ep-requirements.md#nodes-and-ssh), [REQ-025](ep-requirements.md#llm-and-logging)
  - _User Stories:_ [US-08](08-user-stories.md#us-08--pluggable-llm-provider), [US-19](08-user-stories.md#us-19--startup-validation)
  - _Acceptance Criteria:_ [AC-015](stories/US-08/st-acceptance-criteria.md#ac-015), [AC-016](stories/US-08/st-acceptance-criteria.md#ac-016), [AC-033](stories/US-19/st-acceptance-criteria.md#ac-033) (provider load), [AC-036](stories/US-08/st-acceptance-criteria.md#ac-036)
...
- [x] 3.2 Implement Telegram adapter (polling)
  ...
  - On invalid token_path or users file: refuse to start or report clear error ([REQ-024](ep-requirements.md#nodes-and-ssh), [US-19](08-user-stories.md#us-19--startup-validation))
  - _Requirements:_ [REQ-001](ep-requirements.md#interface-and-deployment)
  - _User Stories:_ [US-01](08-user-stories.md#us-01--telegram-bot), [US-19](08-user-stories.md#us-19--startup-validation)
  - _Acceptance Criteria:_ [AC-001](stories/US-01/st-acceptance-criteria.md#ac-001), [AC-033](stories/US-19/st-acceptance-criteria.md#ac-033) (adapter construction)
...
- [x] 3.3 Implement minimal core orchestration
  ...
  - _Requirements:_ [REQ-001](ep-requirements.md#interface-and-deployment), [REQ-008](ep-requirements.md#llm-and-logging)
  - _User Stories:_ [US-01](08-user-stories.md#us-01--telegram-bot), [US-08](08-user-stories.md#us-08--pluggable-llm-provider)
  - _Acceptance Criteria:_ [AC-001](stories/US-01/st-acceptance-criteria.md#ac-001)
...
- [x] 3.4 Message validation (empty / max length)
  ...
  - _Acceptance Criteria:_ [AC-002](stories/US-01/st-acceptance-criteria.md#ac-002)
...
- [x] 3.6 Debug-level LLM conversation logging
  ...
  - _Requirements:_ [REQ-021](ep-requirements.md#llm-and-logging)
  - _User Stories:_ [US-17](08-user-stories.md#us-17--debug-llm-logging)
  - _Acceptance Criteria:_ [AC-031](stories/US-17/st-acceptance-criteria.md#ac-031)
...
- [x] 4.1 Implement long-term memory store (markdown files)
  ...
  - _Requirements:_ [REQ-006](ep-requirements.md#memory-and-indexing), [REQ-018](ep-requirements.md#memory-and-indexing), [REQ-019](ep-requirements.md#memory-and-indexing)
  - _User Stories:_ [US-06](08-user-stories.md#us-06--memory-store)
  - _Acceptance Criteria:_ [AC-011](stories/US-06/st-acceptance-criteria.md#ac-011), [AC-012](stories/US-06/st-acceptance-criteria.md#ac-012)
...
- [x] 4.2 Implement pluggable vector store interface and default implementation
  ...
  - _Requirements:_ [REQ-007](ep-requirements.md#memory-and-indexing), [REQ-024](ep-requirements.md#nodes-and-ssh), [REQ-025](ep-requirements.md#llm-and-logging)
  - _User Stories:_ [US-07](08-user-stories.md#us-07--vector-search), [US-19](08-user-stories.md#us-19--startup-validation)
  - _Acceptance Criteria:_ [AC-013](stories/US-07/st-acceptance-criteria.md#ac-013), [AC-014](stories/US-07/st-acceptance-criteria.md#ac-014), [AC-033](stories/US-19/st-acceptance-criteria.md#ac-033) (embedding load), [AC-037](stories/US-07/st-acceptance-criteria.md#ac-037)
...
- [x] 4.3 Wire memory and vector into core
  ...
  - _Requirements:_ [REQ-006](ep-requirements.md#memory-and-indexing), [REQ-007](ep-requirements.md#memory-and-indexing), [REQ-018](ep-requirements.md#memory-and-indexing)
  - _User Stories:_ [US-06](08-user-stories.md#us-06--memory-store), [US-07](08-user-stories.md#us-07--vector-search)
  - _Acceptance Criteria:_ [AC-011](stories/US-06/st-acceptance-criteria.md#ac-011), [AC-012](stories/US-06/st-acceptance-criteria.md#ac-012), [AC-013](stories/US-07/st-acceptance-criteria.md#ac-013), [AC-014](stories/US-07/st-acceptance-criteria.md#ac-014)
...
- [x] 5.1 Implement SSH client
  ...
  - _Requirements:_ [REQ-004](ep-requirements.md#nodes-and-ssh), [REQ-005](ep-requirements.md#nodes-and-ssh), [REQ-013](ep-requirements.md#nodes-and-ssh)
  ...
  - _Acceptance Criteria:_ [AC-006](stories/US-03/st-acceptance-criteria.md#ac-006), [AC-009](stories/US-05/st-acceptance-criteria.md#ac-009), [AC-010](stories/US-05/st-acceptance-criteria.md#ac-010)
...
- [x] 5.2 Integrate SSH into core
  ...
  - _Requirements:_ [REQ-004](ep-requirements.md#nodes-and-ssh), [REQ-005](ep-requirements.md#nodes-and-ssh), [REQ-013](ep-requirements.md#nodes-and-ssh)
  - _User Stories:_ [US-03](08-user-stories.md#us-03--node-config), [US-04](08-user-stories.md#us-04--per-node-allowlist), [US-05](08-user-stories.md#us-05--dedicated-pa-user-per-node)
  - _Acceptance Criteria:_ [AC-006](stories/US-03/st-acceptance-criteria.md#ac-006), [AC-007](stories/US-04/st-acceptance-criteria.md#ac-007), [AC-008](stories/US-04/st-acceptance-criteria.md#ac-008), [AC-009](stories/US-05/st-acceptance-criteria.md#ac-009), [AC-010](stories/US-05/st-acceptance-criteria.md#ac-010)
...
- [x] 5.3 Write integration tests for SSH (mock or test container)
  ...
  - _Requirements:_ [REQ-004](ep-requirements.md#nodes-and-ssh), [REQ-005](ep-requirements.md#nodes-and-ssh)
  - _User Stories:_ [US-03](08-user-stories.md#us-03--node-config), [US-04](08-user-stories.md#us-04--per-node-allowlist)
  - _Acceptance Criteria:_ [AC-006](stories/US-03/st-acceptance-criteria.md#ac-006), [AC-007](stories/US-04/st-acceptance-criteria.md#ac-007), [AC-008](stories/US-04/st-acceptance-criteria.md#ac-008)
...
- [x] 5.4 Add CLI parameter to verify node availability
  ...
  - _Requirements:_ [REQ-022](ep-requirements.md#nodes-and-ssh)
  - _User Stories:_ [US-18](08-user-stories.md#us-18--verify-node-availability)
  - _Acceptance Criteria:_ [AC-032](stories/US-18/st-acceptance-criteria.md#ac-032)
...
- [x] 6.1 Implement tool contract and registry
  ...
  - _Requirements:_ [REQ-010](ep-requirements.md#scheduler-and-tools), [REQ-011](ep-requirements.md#extensibility-and-architecture)
  ...
  - _Acceptance Criteria:_ [AC-022](stories/US-12/st-acceptance-criteria.md#ac-022), [AC-023](stories/US-12/st-acceptance-criteria.md#ac-023)
...
- [x] 6.2 Implement scheduler (cron)
  ...
  - Missing file, invalid JSON, duplicate or empty task name → empty list or clear error ([AC-034](stories/US-11/st-acceptance-criteria.md#ac-034))
  - _Requirements:_ [REQ-009](ep-requirements.md#scheduler-and-tools), [REQ-023](ep-requirements.md#scheduler-and-tools)
  - _User Stories:_ [US-11](08-user-stories.md#us-11--scheduled-tasks)
  - _Acceptance Criteria:_ [AC-020](stories/US-11/st-acceptance-criteria.md#ac-020), [AC-021](stories/US-11/st-acceptance-criteria.md#ac-021), [AC-034](stories/US-11/st-acceptance-criteria.md#ac-034)
...
- [x] 6.3 Wire tools and scheduler into core
  ...
  - _Requirements:_ [REQ-009](ep-requirements.md#scheduler-and-tools), [REQ-010](ep-requirements.md#scheduler-and-tools)
  - _User Stories:_ [US-11](08-user-stories.md#us-11--scheduled-tasks), [US-12](08-user-stories.md#us-12--extensible-tools)
  - _Acceptance Criteria:_ [AC-020](stories/US-11/st-acceptance-criteria.md#ac-020), [AC-021](stories/US-11/st-acceptance-criteria.md#ac-021), [AC-022](stories/US-12/st-acceptance-criteria.md#ac-022), [AC-023](stories/US-12/st-acceptance-criteria.md#ac-023)
...
- [x] 6.4 Add node/tool via config without image rebuild
  ...
  - _Requirements:_ [REQ-011](ep-requirements.md#extensibility-and-architecture)
  - _User Stories:_ [US-13](08-user-stories.md#us-13--add-nodestools-without-rebuild)
  - _Acceptance Criteria:_ [AC-024](stories/US-13/st-acceptance-criteria.md#ac-024)

- [x] 6.5 Write unit and integration tests for tools and scheduler
  - Tool: valid input → result; invalid input → validation error, tool not run; nil runner or runner error → error to caller ([AC-035](stories/US-12/st-acceptance-criteria.md#ac-035))
  - Scheduler: task at schedule runs; task that would violate security model does not run
  - _Requirements:_ [REQ-009](ep-requirements.md#scheduler-and-tools), [REQ-010](ep-requirements.md#scheduler-and-tools)
  - _User Stories:_ [US-11](08-user-stories.md#us-11--scheduled-tasks), [US-12](08-user-stories.md#us-12--extensible-tools)
  - _Acceptance Criteria:_ [AC-020](stories/US-11/st-acceptance-criteria.md#ac-020), [AC-021](stories/US-11/st-acceptance-criteria.md#ac-021), [AC-022](stories/US-12/st-acceptance-criteria.md#ac-022), [AC-023](stories/US-12/st-acceptance-criteria.md#ac-023), [AC-035](stories/US-12/st-acceptance-criteria.md#ac-035)
...
- [x] 7.1 Implement LLM logging subsystem
  ...
  - _Requirements:_ [REQ-014](ep-requirements.md#llm-and-logging), [REQ-015](ep-requirements.md#llm-and-logging)
  - _User Stories:_ [US-09](08-user-stories.md#us-09--llm-logging), [US-10](08-user-stories.md#us-10--log-destination-and-format)
  - _Acceptance Criteria:_ [AC-017](stories/US-09/st-acceptance-criteria.md#ac-017), [AC-018](stories/US-10/st-acceptance-criteria.md#ac-018)
...
- [x] 7.2 Handle unavailable log destination
  ...
  - _Requirements:_ [REQ-015](ep-requirements.md#llm-and-logging)
  - _User Stories:_ [US-10](08-user-stories.md#us-10--log-destination-and-format)
  - _Acceptance Criteria:_ [AC-019](stories/US-10/st-acceptance-criteria.md#ac-019)

- [x] 7.3 Ensure logs never contain secret values; redaction with built-in + additional patterns ([REQ-017](ep-requirements.md#secret-protection-prompt-injection--exfiltration), REQ-026–REQ-029)
  ...
  - _Requirements:_ [REQ-017](ep-requirements.md#secret-protection-prompt-injection--exfiltration), [REQ-026](ep-requirements.md#secret-protection-prompt-injection--exfiltration), [REQ-027](ep-requirements.md#secret-protection-prompt-injection--exfiltration), [REQ-028](ep-requirements.md#secret-protection-prompt-injection--exfiltration), [REQ-029](ep-requirements.md#secret-protection-prompt-injection--exfiltration)
  - _User Stories:_ [US-16](08-user-stories.md#us-16--secret-leakage-protection)
  - _Acceptance Criteria:_ [AC-028](stories/US-16/st-acceptance-criteria.md#ac-028), [AC-029](stories/US-16/st-acceptance-criteria.md#ac-029), [AC-030](stories/US-16/st-acceptance-criteria.md#ac-030), [AC-038](stories/US-16/st-acceptance-criteria.md#ac-038), [AC-039](stories/US-16/st-acceptance-criteria.md#ac-039), [AC-040](stories/US-16/st-acceptance-criteria.md#ac-040), [AC-041](stories/US-16/st-acceptance-criteria.md#ac-041)
...
- [x] 7.4 Write unit tests for LLM logging
  ...
  - _Requirements:_ [REQ-014](ep-requirements.md#llm-and-logging), [REQ-015](ep-requirements.md#llm-and-logging)
  - _User Stories:_ [US-09](08-user-stories.md#us-09--llm-logging), [US-10](08-user-stories.md#us-10--log-destination-and-format)
  - _Acceptance Criteria:_ [AC-017](stories/US-09/st-acceptance-criteria.md#ac-017), [AC-018](stories/US-10/st-acceptance-criteria.md#ac-018), [AC-019](stories/US-10/st-acceptance-criteria.md#ac-019)
...
- [x] 8.1 Day summarization (LLM logs only)
  ...
  - _Requirements:_ [REQ-019](ep-requirements.md#memory-and-indexing), [REQ-020](ep-requirements.md#memory-and-indexing)
  - _User Stories:_ [US-06](08-user-stories.md#us-06--memory-store)
  - _Acceptance Criteria:_ [AC-011](stories/US-06/st-acceptance-criteria.md#ac-011), [AC-012](stories/US-06/st-acceptance-criteria.md#ac-012)
...
- [x] 8.2 Write unit and integration tests for day summarization
  ...
  - _Requirements:_ [REQ-019](ep-requirements.md#memory-and-indexing), [REQ-020](ep-requirements.md#memory-and-indexing)
  - _User Stories:_ [US-06](08-user-stories.md#us-06--memory-store)
  - _Acceptance Criteria:_ [AC-011](stories/US-06/st-acceptance-criteria.md#ac-011), [AC-012](stories/US-06/st-acceptance-criteria.md#ac-012) (summarization inputs and structure)
...
- [x] 9.1 Add Dockerfile and docker-compose
  ...
  - _Requirements:_ [REQ-002](ep-requirements.md#interface-and-deployment)
  - _User Stories:_ [US-02](08-user-stories.md#us-02--docker-deploy)
  - _Acceptance Criteria:_ [AC-003](stories/US-02/st-acceptance-criteria.md#ac-003), [AC-004](stories/US-02/st-acceptance-criteria.md#ac-004)
...
- [x] 9.2 Verify container start and one conversation
  ...
  - _Requirements:_ [REQ-002](ep-requirements.md#interface-and-deployment)
  - _User Stories:_ [US-02](08-user-stories.md#us-02--docker-deploy)
  - _Acceptance Criteria:_ [AC-003](stories/US-02/st-acceptance-criteria.md#ac-003)
...
- [x] 10.1 Document and enforce clear module boundaries
  ...
  - _Requirements:_ [REQ-012](ep-requirements.md#extensibility-and-architecture)
  - _User Stories:_ [US-14](08-user-stories.md#us-14--architecture-boundaries)
  - _Acceptance Criteria:_ [AC-025](stories/US-14/st-acceptance-criteria.md#ac-025)
...
- [ ] 10.2 Versioned state (git-backed config/memory) — scope TBD
  ...
  - _Requirements:_ [REQ-016](ep-requirements.md#version-control-and-audit)
  - _User Stories:_ [US-15](08-user-stories.md#us-15--version-control-git)
  - _Acceptance Criteria:_ [AC-026](stories/US-15/st-acceptance-criteria.md#ac-026), [AC-027](stories/US-15/st-acceptance-criteria.md#ac-027)

---

## 11. Secret leakage protection ([REQ-017](ep-requirements.md#secret-protection-prompt-injection--exfiltration), REQ-026–REQ-029)

_Do this when most functionality is in place._

- [ ] 11.1 Secret leakage protection ([REQ-017](ep-requirements.md#secret-protection-prompt-injection--exfiltration), REQ-026–REQ-029)
  ...
  - Logging: ensure LLM logging and app logging apply redaction (built-in + optional additional patterns) and never write secret values (test with capturing logger; assert captured output is free of fake secrets). Config validation: refuse start when additional pattern id is reserved or regex invalid (AC-041). See [strategy.md § Test strategy — Secret leakage](../../strategy.md) (legacy: docs/EP-104/06-test-strategy.md §5).
  - _Requirements:_ [REQ-017](ep-requirements.md#secret-protection-prompt-injection--exfiltration), [REQ-026](ep-requirements.md#secret-protection-prompt-injection--exfiltration), [REQ-027](ep-requirements.md#secret-protection-prompt-injection--exfiltration), [REQ-028](ep-requirements.md#secret-protection-prompt-injection--exfiltration), [REQ-029](ep-requirements.md#secret-protection-prompt-injection--exfiltration)
  - _User Stories:_ [US-16](08-user-stories.md#us-16--secret-leakage-protection)
  - _Acceptance Criteria:_ [AC-028](stories/US-16/st-acceptance-criteria.md#ac-028), [AC-029](stories/US-16/st-acceptance-criteria.md#ac-029), [AC-030](stories/US-16/st-acceptance-criteria.md#ac-030), [AC-038](stories/US-16/st-acceptance-criteria.md#ac-038), [AC-039](stories/US-16/st-acceptance-criteria.md#ac-039), [AC-040](stories/US-16/st-acceptance-criteria.md#ac-040), [AC-041](stories/US-16/st-acceptance-criteria.md#ac-041)
...
- [ ] 12.1 Final checkpoint — Ensure all acceptance criteria are met by reviewing the code and running unit and integration tests, ask the user if questions arise.
  ...
  - _Acceptance Criteria:_ [AC-001–AC-042](10-acceptance-criteria.md) (see [strategy.md](../../strategy.md)). Include secret leakage protection tests ([REQ-017](ep-requirements.md#secret-protection-prompt-injection--exfiltration), REQ-026–REQ-029; [strategy.md](../../strategy.md)).
