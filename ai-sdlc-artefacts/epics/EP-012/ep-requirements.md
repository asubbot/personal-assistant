...
### REQ-12.001 — HTML parse mode for outbound text
...
### REQ-12.003 — Supported Markdown mappings
...
### REQ-12.004 — Fallback on entity error
...
### REQ-12.005 — Typing for user turns
...
### REQ-12.006 — Typing errors non-blocking
