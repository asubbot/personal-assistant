...
- [ ] **1. Delete `internal/logging` stub package**
...
- [ ] **2. Add `internal/prompt` production sources (`markers.go`, `wrap.go`)**
...
- [ ] **3. Add `internal/prompt` unit tests with independent byte-identity goldens (S-001)**
...
- [ ] **4. Rewrite all seven importers to `pa/internal/prompt`**
...
- [ ] **5. Delete legacy `internal/promptmarkers` and `internal/systemprompt`**
...
- [ ] **6. Add `tests/integration/concurrent_write_test.go`**
...
- [ ] **8. Update `docs/configuration.md` reliability test path**
...
- [ ] **9. Epic quality gates and removal grep**
