...
| # | Issue | Context | Recommendation |
|---|-------|---------|----------------|
| M1 | **Missing “Risks and trade-offs” section** | The [system-design-review.skill.md](../../../ai-sdlc/specification/skills/system-design-review.skill.md) structural checklist expects risks and trade-offs; [ep-system-design.md](ep-system-design.md) has no such section. | Add a short section (e.g. embedding cost at startup, marker maintenance, budget eviction impact on tool availability, Hermes vs native parity) with mitigations. |
