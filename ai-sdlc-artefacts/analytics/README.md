...
| PA architecture review | [../pa-architecture-review.md](../pa-architecture-review.md) — code-grounded architecture review with C4 diagrams and strengths/weaknesses/risks (English; lives in artefacts root) |
