...
func TestRun_nilAdapter_returnsError(t *testing.T) {
	...
	err := Run(context.Background(), cfg, logger, nil, []llm.Provider{provider}, []string{"test/default"}, nil, nil, nil, nil, nil, nil, nil)
	if err == nil {
...
func TestRun_nilProvider_returnsError(t *testing.T) {
	...
	err := Run(context.Background(), cfg, logger, adapter, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	if err == nil {
...
func TestRun_callsAdapterRunWithHandler(t *testing.T) {
	...
	err := Run(context.Background(), cfg, logger, adapter, []llm.Provider{provider}, []string{"test/default"}, nil, nil, nil, nil, nil, nil, nil)
	if err != nil {
		t.Fatalf("Run: %v", err)
	}
...
func TestRun_cfgNil_noPanic_handlerGetsZeroMaxLength(t *testing.T) {
	...
	err := Run(context.Background(), nil, logger, adapter, []llm.Provider{provider}, []string{"test/default"}, nil, nil, nil, nil, nil, nil, nil)
	if err != nil {
...
func TestRun_labelsLengthMismatch_returnsError(t *testing.T) {
	...
	adapter := &capturingAdapter{}
	err := Run(context.Background(), cfg, logger, adapter, []llm.Provider{p}, nil, nil, nil, nil, nil, nil, nil, nil)
	if err == nil {
...
func TestRun_providerChain_wiresHandler(t *testing.T) {
	...
	adapter := &capturingAdapter{}
	err := Run(context.Background(), cfg, logger, adapter, []llm.Provider{p}, []string{"openai/gpt"}, nil, nil, nil, nil, nil, nil, nil)
	if err != nil {
		t.Fatalf("Run: %v", err)
	}
