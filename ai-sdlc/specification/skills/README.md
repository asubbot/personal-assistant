...
| [system-design-review.skill.md](system-design-review.skill.md) | Review `ep-system-design.md` for quality, traceability, and compliance before implementation |
...
| **System design review** / architecture review / requirement traceability | [system-design-review.skill.md](system-design-review.skill.md) |
...
Numbered: `01`–`09` (table above). Cross-cutting: `code-review.skill.md`, `ep-C4-component.skill.md`, `project-comparison-report.skill.md`, `system-design-review.skill.md`, `user-documentation.skill.md`, `threat-model-report.skill.md`.
