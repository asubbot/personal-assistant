...
**Output:** ai-sdlc-artefacts/epics/<epic-id>/04-system-design.md
...
- Draft the design first; show the user (e.g. section by section). Update ai-sdlc-artefacts/epics/<epic-id>/04-system-design.md only when the user explicitly approves (e.g. "lgtm", "save").
...
**Rules:** Use English. Keep traceability to requirements and research.
