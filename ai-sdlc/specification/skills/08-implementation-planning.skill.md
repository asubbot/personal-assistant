...
**Inputs:** st-scope.md, st-acceptance-criteria.md (ai-sdlc-artefacts/epics/<epic-id>/stories/<story-id>/), ep-system-design.md, and test strategy.
...
**Process:** Ensure st-scope and st-acceptance-criteria exist for the story. Draft the plan first; show the user. Update ai-sdlc-artefacts/epics/<epic-id>/stories/<story-id>/st-implementation-plan.md only when the user explicitly approves (e.g. "lgtm", "save").
