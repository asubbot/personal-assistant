...
**Inputs:** Implemented and approved artifacts, deployment strategy and environment config, and delivery strategy (increment boundaries). Delivery strategy is in ai-sdlc-artefacts/epics/<epic-id>/05-delivery-strategy.md.
