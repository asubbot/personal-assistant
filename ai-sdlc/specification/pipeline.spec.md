...
flowchart TB
  ...
  G[7. Acceptance criteria planning]
...
| 5. System design | [05-system-design.skill.md](skills/05-system-design.skill.md) | Components, interfaces, decisions | ep-requirements.md | epics/<epic-id>/ep-system-design.md |
| 6. User story planning | [06-user-story-planning.skill.md](skills/06-user-story-planning.skill.md) | Story scope per story | ep-requirements, ep-system-design | epics/<epic-id>/stories/<story-id>/st-scope.md |
| 7. Acceptance criteria planning | [07-acceptance-criteria-planning.skill.md](skills/07-acceptance-criteria-planning.skill.md) | Testable conditions per story | st-scope.md | stories/<story-id>/st-acceptance-criteria.md |
...
flowchart LR
  ...
  scope --> strategy --> ep_scope --> ep_req --> ep_design
  ep_design --> st_scope --> st_ac --> st_impl --> repo[Repo]
