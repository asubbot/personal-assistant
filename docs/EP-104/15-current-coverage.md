...
| [AC-036](10-acceptance-criteria.md#ac-036-us-08) | ✓ | — | — | — | `internal/llm/openai_test.go` (Complete error paths: empty choices, 4xx, invalid JSON, context canceled, unreachable) |
| [AC-037](10-acceptance-criteria.md#ac-037-us-07) | ✓ | — | — | — | `internal/embedding/openai_test.go` (Embed error paths: empty data, 4xx, invalid JSON, context canceled, unreachable) |
| [AC-017](10-acceptance-criteria.md#ac-017-us-09), [AC-018](10-acceptance-criteria.md#ac-018-us-10), [AC-019](10-acceptance-criteria.md#ac-019-us-10), [AC-026](10-acceptance-criteria.md#ac-026-us-15), [AC-028](10-acceptance-criteria.md#ac-028-us-16)–[AC-030](10-acceptance-criteria.md#ac-030-us-16), [AC-038](10-acceptance-criteria.md#ac-038-us-16)–[AC-041](10-acceptance-criteria.md#ac-041-us-16) | — | — | — | — | No tests yet; feature or task not implemented (see [11-12-implementation-plan.md](11-12-implementation-plan.md)). |

**Implementation-detail tests (No AC):** `cmd/pa/main_test.go` — config path from PA_CONFIG_DIR (set / unset or empty). `internal/config/resolve_test.go` — path resolution (PA_DATA_DIR, PA_SECRETS_DIR): relative paths joined with bases, absolute unchanged, empty unchanged, env unset uses ".".
