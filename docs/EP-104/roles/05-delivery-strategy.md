...
- Draft the strategy first; show the user (e.g. section by section). Update [05-delivery-strategy.md](../05-delivery-strategy.md) only when the user explicitly approves (e.g. "lgtm", "save").
