...
**Draft-then-approve:** Do not save documents immediately. Draft content, show the user full content (e.g. section by section), ask for clarification. Only create or update [01-02-requirements.md](../01-02-requirements.md) when the user explicitly approves (e.g. “lgtm”, “save”).
