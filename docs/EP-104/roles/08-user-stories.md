...
**Goal:** Produce the user stories document: story ID (e.g. US-01…US-N), title, formulation (As a … I want … so that …), and links to requirements. Acceptance criteria are separate entities (stage 9).
...
- Draft stories first; show the user (e.g. story by story). Update [08-user-stories.md](../08-user-stories.md) only when the user explicitly approves (e.g. "lgtm", "save").
