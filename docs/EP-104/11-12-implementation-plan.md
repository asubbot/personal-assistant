...
**Purpose:** Ordered task list with dependencies, checkpoints, and verification; traceability to REQ/AC.  
...
- [x] 1. Set up Go module and package structure
  ...
  - _Requirements: [REQ-002](01-02-requirements.md#interface-and-deployment), [REQ-012](01-02-requirements.md#extensibility-and-architecture)_
  - **Execution:**
...
- [x] 2.1 Implement per-node allowlist model
  ...
  - _Requirements: [REQ-005](01-02-requirements.md#nodes-and-ssh)_
  - _Validates:_ [AC-007](10-acceptance-criteria.md#ac-007-us-04), [AC-008](10-acceptance-criteria.md#ac-008-us-04)
...
- [x] 2.2 Enforce dedicated SSH user per node
  ...
  - _Requirements: [REQ-013](01-02-requirements.md#nodes-and-ssh)_
  - _Validates:_ [AC-009](10-acceptance-criteria.md#ac-009-us-05), [AC-010](10-acceptance-criteria.md#ac-010-us-05)
...
- [x] 2.3 Write unit tests for allowlist and dedicated user
  ...
  - _Validates:_ [AC-007](10-acceptance-criteria.md#ac-007-us-04), [AC-008](10-acceptance-criteria.md#ac-008-us-04), [AC-009](10-acceptance-criteria.md#ac-009-us-05)
...
- [x] 3.3 Implement minimal core orchestration
  ...
  - _Requirements: [REQ-001](01-02-requirements.md#interface-and-deployment), [REQ-008](01-02-requirements.md#llm-and-logging)_
...
- [x] 3.4 Message validation (empty / max length)
  ...
  - _Requirements: [REQ-001](01-02-requirements.md#interface-and-deployment)_
  - _Validates:_ [AC-002](10-acceptance-criteria.md#ac-002-us-01)
...
- [x] 3.6 Debug-level LLM conversation logging
  ...
  - _Requirements: [REQ-021](01-02-requirements.md#llm-and-logging)_
  - _Validates:_ [AC-031](10-acceptance-criteria.md#ac-031-us-17)
...
- [x] 4.1 Implement long-term memory store (markdown files)
  ...
  - _Requirements: [REQ-006](01-02-requirements.md#memory-and-indexing), [REQ-018](01-02-requirements.md#memory-and-indexing), [REQ-019](01-02-requirements.md#memory-and-indexing)_
  - _Validates:_ [AC-011](10-acceptance-criteria.md#ac-011-us-06), [AC-012](10-acceptance-criteria.md#ac-012-us-06)
...
- [x] 4.3 Wire memory and vector into core
  ...
  - _Requirements: [REQ-006](01-02-requirements.md#memory-and-indexing), [REQ-007](01-02-requirements.md#memory-and-indexing), [REQ-018](01-02-requirements.md#memory-and-indexing)_
...
- [x] 4.4 Write unit and integration tests for memory and vector
  ...
  - _Validates:_ [AC-011](10-acceptance-criteria.md#ac-011-us-06), [AC-012](10-acceptance-criteria.md#ac-012-us-06), [AC-013](10-acceptance-criteria.md#ac-013-us-07), [AC-014](10-acceptance-criteria.md#ac-014-us-07)
...
- [x] 5.1 Implement SSH client
  ...
  - _Requirements: [REQ-004](01-02-requirements.md#nodes-and-ssh), [REQ-005](01-02-requirements.md#nodes-and-ssh), [REQ-013](01-02-requirements.md#nodes-and-ssh)_
  - _Validates:_ [AC-006](10-acceptance-criteria.md#ac-006-us-03), [AC-009](10-acceptance-criteria.md#ac-009-us-05), [AC-010](10-acceptance-criteria.md#ac-010-us-05)
...
- [x] 5.3 Write integration tests for SSH (mock or test container)
  ...
  - _Validates:_ [AC-006](10-acceptance-criteria.md#ac-006-us-03), [AC-007](10-acceptance-criteria.md#ac-007-us-04), [AC-008](10-acceptance-criteria.md#ac-008-us-04)
...
- [x] 5.4 Add CLI parameter to verify node availability
  ...
  - _Requirements: [REQ-022](01-02-requirements.md#nodes-and-ssh)_
  - _Validates:_ [AC-032](10-acceptance-criteria.md#ac-032-us-18)
...
- [x] 6.1 Implement tool contract and registry
  ...
  - _Requirements: [REQ-010](01-02-requirements.md#scheduler-and-tools), [REQ-011](01-02-requirements.md#extensibility-and-architecture)_
  - _Validates:_ [AC-022](10-acceptance-criteria.md#ac-022-us-12), [AC-023](10-acceptance-criteria.md#ac-023-us-12)
...
- [x] 6.3 Wire tools and scheduler into core
  ...
  - _Requirements: [REQ-009](01-02-requirements.md#scheduler-and-tools), [REQ-010](01-02-requirements.md#scheduler-and-tools)_
...
- [x] 6.4 Add node/tool via config without image rebuild
  ...
  - _Requirements: [REQ-011](01-02-requirements.md#extensibility-and-architecture)_
...
- [ ] 7.1 Implement LLM logging subsystem
  ...
  - _Requirements: [REQ-014](01-02-requirements.md#llm-and-logging), [REQ-015](01-02-requirements.md#llm-and-logging)_
  - _Validates:_ [AC-017](10-acceptance-criteria.md#ac-017-us-09), [AC-018](10-acceptance-criteria.md#ac-018-us-10)
...
- [ ] 7.2 Handle unavailable log destination
  ...
  - _Requirements: [REQ-015](01-02-requirements.md#llm-and-logging)_
  - _Validates:_ [AC-019](10-acceptance-criteria.md#ac-019-us-10)
...
- [ ] 7.3 Ensure logs never contain secret values ([REQ-017](01-02-requirements.md#secret-protection-prompt-injection--exfiltration))
  ...
  - _Requirements: [REQ-017](01-02-requirements.md#secret-protection-prompt-injection--exfiltration)_
...
- [ ] 7.4 Write unit tests for LLM logging
  ...
  - _Validates:_ [AC-017](10-acceptance-criteria.md#ac-017-us-09), [AC-018](10-acceptance-criteria.md#ac-018-us-10), [AC-019](10-acceptance-criteria.md#ac-019-us-10)
...
- [ ] 8.1 Hierarchical memory summarization (day / month / year)
  ...
  - _Requirements: [REQ-019](01-02-requirements.md#memory-and-indexing), [REQ-020](01-02-requirements.md#memory-and-indexing)_
...
- [ ] 8.2 Write unit and integration tests for hierarchical summarization
  ...
  - _Validates:_ [REQ-019](01-02-requirements.md#memory-and-indexing), [REQ-020](01-02-requirements.md#memory-and-indexing) (summarization inputs and structure)
...
- [ ] 9.1 Add Dockerfile and docker-compose
  ...
  - _Requirements: [REQ-002](01-02-requirements.md#interface-and-deployment)_
  - _Validates:_ [AC-003](10-acceptance-criteria.md#ac-003-us-02), [AC-004](10-acceptance-criteria.md#ac-004-us-02)
...
- [ ] 9.2 Verify container start and one conversation
  ...
  - _Requirements: [REQ-002](01-02-requirements.md#interface-and-deployment)_
  - _Validates:_ [AC-003](10-acceptance-criteria.md#ac-003-us-02)
...
- [ ] 10.1 Document and enforce clear module boundaries
  ...
  - _Requirements: [REQ-012](01-02-requirements.md#extensibility-and-architecture)_
  - _Validates:_ [AC-025](10-acceptance-criteria.md#ac-025-us-14)
...
- [ ] 10.2 Versioned state (git-backed config/memory) — scope TBD
  ...
  - _Requirements: [REQ-016](01-02-requirements.md#version-control-and-audit)_
  - _Validates:_ [AC-026](10-acceptance-criteria.md#ac-026-us-15), [AC-027](10-acceptance-criteria.md#ac-027-us-15)
